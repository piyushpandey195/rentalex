...
import '../filter_wanted/filter_wanted_screen.dart';
import '../home/widget/body_data_view.dart';
class WantedScreen extends StatefulWidget {
  const WantedScreen({Key? key}) : super(key: key);
      ...
      body: Stack(
        children: [
          ...
          Positioned(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>FilterWantedScreen()));
                },
                child: Container(
                  width: width,
                  height: 48,
