...
class OthersFAQScreen extends StatefulWidget {
  const OthersFAQScreen({Key? key}) : super(key: key);

  @override
  State<OthersFAQScreen> createState() => _OthersFAQScreenState();
}

class _OthersFAQScreenState extends State<OthersFAQScreen> {
  @override
          ...
          child:  Column(
            ...
            children: [
              Row(children: [
                ...
                Text("Others FAQ",style: GoogleFonts.roboto(
