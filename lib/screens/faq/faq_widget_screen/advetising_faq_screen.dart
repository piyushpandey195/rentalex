...
class AdvetisingFAQScreen extends StatefulWidget {
  const AdvetisingFAQScreen({Key? key}) : super(key: key);

  @override
  State<AdvetisingFAQScreen> createState() => _AdvetisingFAQScreenState();
}

class _AdvetisingFAQScreenState extends State<AdvetisingFAQScreen> {
  @override
          ...
          child:  Column(
            ...
            children: [
              Row(children: [
                ...
                Text("Advertising FAQ",style: GoogleFonts.roboto(
