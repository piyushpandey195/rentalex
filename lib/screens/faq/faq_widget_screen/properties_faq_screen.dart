...
class PropertiesFAQScreen extends StatefulWidget {
  const PropertiesFAQScreen({Key? key}) : super(key: key);

  @override
  State<PropertiesFAQScreen> createState() => _PropertiesFAQScreenState();
}

class _PropertiesFAQScreenState extends State<PropertiesFAQScreen> {
  @override
