...
class WantedFAQScreen extends StatefulWidget {
  const WantedFAQScreen({Key? key}) : super(key: key);

  @override
  State<WantedFAQScreen> createState() => _WantedFAQScreenState();
}

class _WantedFAQScreenState extends State<WantedFAQScreen> {
  @override
          ...
          child:  Column(
            ...
            children: [
              Row(children: [
                ...
                Text("Wanted FAQ",style: GoogleFonts.roboto(
