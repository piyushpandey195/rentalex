...
class GeneralFAQScreen extends StatefulWidget {
  const GeneralFAQScreen({Key? key}) : super(key: key);

  @override
  State<GeneralFAQScreen> createState() => _GeneralFAQScreenState();
}

class _GeneralFAQScreenState extends State<GeneralFAQScreen> {
  @override
          ...
          child:  Column(
            ...
            children: [
              Row(children: [
                ...
                Text("General FAQ",style: GoogleFonts.roboto(
