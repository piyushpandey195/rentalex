...
class VehiclesFAQScreen extends StatefulWidget {
  const VehiclesFAQScreen({Key? key}) : super(key: key);

  @override
  State<VehiclesFAQScreen> createState() => _VehiclesFAQScreenState();
}

class _VehiclesFAQScreenState extends State<VehiclesFAQScreen> {
  @override
          ...
          child:  Column(
            ...
            children: [
              Row(children: [
                ...
                Text(" Vehicles FAQ",style: GoogleFonts.roboto(
